...
import { useBankStore, useBaseStore, useGovStore, useMintStore, useStakingStore, useWalletStore } from '.';
...
export const useBlockchain = defineStore('blockchain', {
  ...
  actions: {
    ...
    async setCurrent(name: string) {
      ...
      const caseSensitiveName = Object.keys(this.dashboard.chains).find((x) => x.toLowerCase() === name.toLowerCase()) || name;
