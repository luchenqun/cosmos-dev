  ...
  <div>
    ...
    <div class="form-control">
      ...
      <select v-model="denom" class="select select-bordered dark:text-white" @change="updateIBCToken">
        ...
        <option v-for="{ base, display } in showBalances" :value="base.denom">{{ display.amount }} {{ formatDenom(display.denom) }}</option>
      </select>
    </div>
    <div class="form-control">
      <label class="label">
      ...
      <select v-model="dest" class="select select-bordered capitalize dark:text-white" @change="selectDest" :disabled="destDisabled">
    ...
    <div class="form-control">
      ...
      <input v-model="recipient" type="text" class="input border border-gray-300 dark:border-gray-600 dark:text-white" />
    </div>
    <div class="form-control">
      <label class="label">
