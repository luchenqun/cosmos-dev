...
import { getAccount, getBalance, getBalanceMetadata, getIBCDenomMetadata, getLatestBlock, getStakingParam, getTxByHash } from '../../utils/http';
import type { Coin, CoinMetadata } from '../../utils/type';
import { WalletName, readWallet } from '../../wallet/Wallet';
  ...
  <div class="text-gray-600">
    ...
    <label :for="type" class="modal cursor-pointer">
      <label class="modal-box relative p-5" :class="{ '!w-11/12 !max-w-5xl': String(type).startsWith('wasm') }" for="">
        ...
        <div v-if="!sender" class="text-center h-16 items-center">No wallet connected!</div>
          ...
          <div v-if="view === 'input'">
              ...
              <div :class="advance ? '' : 'hidden'">
                <div class="form-control">
                  ...
                  <label class="input-group flex items-center">
                    <input v-model="feeAmount" type="text" placeholder="0.001" class="input border border-gray-300 dark:border-gray-600 flex-1 w-0 dark:text-gray-300" />
                    <select v-model="feeDenom" class="select input border border-gray-300 dark:border-gray-600 w-[200px]">
                ...
                <div class="form-control">
                  ...
                  <input v-model="gasInfo" type="number" placeholder="2000000" class="input border border-gray-300 dark:border-gray-600 dark:text-gray-300" />
                </div>
                <div class="form-control">
                  <label class="label">
                    <span class="label-text">Memo</span>
                  </label>
                  <input v-model="memo" type="text" placeholder="Memo" class="input border border-gray-300 dark:border-gray-600 dark:text-gray-300" />
                </div>
              </div>
            </form>
            ...
            <div class="modal-action flex justify-between items-center">
              <div class="flex items-center cursor-pointer">
                <input v-model="advance" type="checkbox" :id="`${type}-advance`" class="checkbox checkbox-sm checkbox-primary mr-2" /><label
                  :for="`${type}-advance`"
