...
<template>
  <div>
    ...
    <!-- modal -->
    <div v-if="searchModalShow" class="cursor-pointer modal !pointer-events-auto !opacity-100 !visible" @click="closeSearchModal">
      <div class="relative modal-box cursor-default" @click="(event) => preventClick(event)">
        ...
        <div class="mt-4">
          <div class="">
            <input class="input flex-1 w-full !input-bordered" v-model="searchQuery" placeholder="Height/Transaction/Account Address" />
