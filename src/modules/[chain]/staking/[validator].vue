...
import { useBlockchain, useFormatter, useMintStore, useStakingStore, useTxDialog } from '@/stores';
          ...
          <div class="m-4 text-sm">
            ...
            <div class="card-list">
              <div class="flex items-center mb-2">
                ...
                <a :href="v?.description?.website || '#'" :class="v?.description?.website ? 'cursor-pointer' : 'cursor-default'">
              ...
              <div class="flex items-center">
                ...
                <a v-if="v.description?.security_contact" :href="'mailto:' + v.description.security_contact || '#'" class="cursor-pointer">
      ...
      <div class="bg-base-100 rounded shadow relative overflow-auto">
        ...
        <div class="px-4 mt-1 flex flex-col justify-between pb-4 max-h-72" style="height: calc(100% - 50px)">
          <div class="overflow-auto flex-1">
            ...
            <div v-for="(i, k) in commission" :key="`reward-${k}`" color="info" label variant="outlined" class="mr-1 mb-1 badge text-xs">
        ...
        <div class="px-4 pb-4">
          <div class="mb-3">
            <div class="text-sm flex">
              ...
              <Icon icon="mdi:content-copy" class="ml-2 cursor-pointer" v-show="addresses.account" @click="copyWebsite(addresses.account || '')" />
            </div>
          ...
          <div class="mb-3">
            <div class="text-sm flex">
              ...
              <Icon icon="mdi:content-copy" class="ml-2 cursor-pointer" v-show="v.operator_address" @click="copyWebsite(v.operator_address || '')" />
            </div>
            <div class="text-xs">
              {{ v.operator_address }}
            </div>
          ...
          <div class="mb-3">
            <div class="text-sm flex">
              {{ $t('staking.hex_addr') }}
              <Icon icon="mdi:content-copy" class="ml-2 cursor-pointer" v-show="addresses.hex" @click="copyWebsite(addresses.hex || '')" />
            </div>
          ...
          <div class="mb-3">
            <div class="text-sm flex">
              ...
              <Icon icon="mdi:content-copy" class="ml-2 cursor-pointer" v-show="addresses.valCons" @click="copyWebsite(addresses.valCons || '')" />
            </div>
          ...
          <div>
            <div class="text-sm flex">
              ...
              <Icon icon="mdi:content-copy" class="ml-2 cursor-pointer" v-show="v.consensus_pubkey" @click="copyWebsite(JSON.stringify(v.consensus_pubkey) || '')" />
            </div>
    ...
    <div class="mt-5 bg-base-100 shadow rounded p-4">
      <div class="text-lg mb-4 font-semibold">
        <div class="tabs tabs-boxed bg-transparent">
          ...
          <a class="tab text-gray-400" :class="{ 'tab-active': selectedEventType === EventType.Delegate }" @click="loadPowerEvents(1, EventType.Delegate)">{{
            $t('account.btn_delegate')
          }}</a>
          <a class="tab text-gray-400" :class="{ 'tab-active': selectedEventType === EventType.Unbond }" @click="loadPowerEvents(1, EventType.Unbond)">{{
        ...
        <table class="table validatore-table w-full">
          ...
          <tbody>
            <tr v-for="(item, i) in events.tx_responses">
              ...
              <td width="150">
                <RouterLink class="text-primary mb-0" :to="`/${props.chain}/block/${item.height}`">{{ item.height }}</RouterLink
                ><br />
