  ...
  <div>
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
      ...
      <div class="text-sm">
        ...
        <a class="text-primary lowercase" href="https://blog.cosmos.network/cosmos-sdk-state-sync-guide-99e4cf43be2f">{{ $t('statesync.here') }}&nbsp;</a>
    ...
    <div class="bg-base-100 px-4 pt-3 pb-4 rounded mb-4 shadow">
      ...
      <div class="text-sm">
        1. {{ $t('statesync.text_1') }} ({{ appName }} {{ $t('statesync.version') }}: {{ nodeInfo.application_version?.version || '' }})
        <br />
